            ...
            <div class="container">
                ...
                <div class="header-inner">
                    <div class="palla">
                        ...
                        <input id="hamburger" type="checkbox" class="visually-hidden"></input>
    
                                        
                    <nav class="navigation">
                        <ul>
                            <li class="lip"><a href="/">Home</a></li>
                            <li class="lip"><a href="/">About Us</a></li>
                            <li class="lip"><a href="/">Shop</a></li>
                            <li class="lip"><a href="/">Contact</a></li>

                            <div class="dop">
                                <li><a href="/"><svg width="15" height="17" viewBox="0 0 15 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li><a href="/"><svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
